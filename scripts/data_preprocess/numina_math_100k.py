...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data/numina_math_100k')
    ...
    train_dataset.shuffle(seed=42).select(range(100000)).to_parquet(os.path.join(local_dir, 'train.parquet'))
